package com.example.learning.steps;
...
import com.example.learning.basket.BasketService;
import com.example.learning.entity.Order;
import io.cucumber.java8.En;
import io.cucumber.spring.ScenarioScope;
@ScenarioScope
//@ContextConfiguration(classes = LearningApplication.class,  loader = SpringBootContextLoader.class)
public class Basket implements En {
    ...
    public Basket() {
        ...
        When("^the selected quality is greater than (\\d+)$", (Integer arg0) -> {
